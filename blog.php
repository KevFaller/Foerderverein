...
<div class="bg-white py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <?php
    $sqlFirst = "SELECT title,text,bild,autor,created FROM Beitrag Order by created DESC";
    $result = mysqli_query($connection, $sql);
    $firstId = mysqli_fetch_assoc($result)["title"];
        ...
        <article class="flex flex-col items-start justify-between">
          ...
          <div class="max-w-xl">
            ...
            <div class="relative mt-8 flex items-center gap-x-4">
              <img src="./Media/Foerderverein_logo.ico" alt="Profile" class="h-10 w-10 rounded-full bg-gray-100">
